    ...
    <div>
        ...
        <Conteudo>
          ...
          <section>
            ...
            <h2>Faça login no aplicativo</h2>
            <p><b>Descrição: </b>Baixe e instale o aplicativo correspondente ao dispositivo em seu smartphone ou tablet.</p>
            <p><b>Detalhes: </b>Acesse a App Store (iOS) ou Google Play Store (Android) e procure pelo nome do aplicativo. Siga as instruções na tela para instalar o aplicativo.</p>
            <p><b>Dica: </b>Utilize um e-mail ativo e crie uma senha segura para a conta.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <h2>Coloque o bracelete</h2>
            <p><b>Descrição: </b>Coloque o bracelete no pulso da criança.</p>
            <p><b>Detalhes: </b>Certifique-se de que o bracelete esteja bem ajustado, mas confortável, para que os sensores possam funcionar corretamente.</p>
            <p><b>Dica: </b>Verifique se o bracelete não está muito apertado, para evitar desconforto ou irritação na pele.</p>
          </section>
          <section>
